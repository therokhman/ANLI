...
const ModesContainer = () => {
    return(
        <Stack.Navigator initialRouteName="modes">
            ...
            <Stack.Screen name="martaller" component={ModesContent} initialParams = {data.martaller} options={{ title: 'Метод Марталлера', headerBackTitleVisible: false, headerStyle: {backgroundColor: '#83aba4'} }} />
