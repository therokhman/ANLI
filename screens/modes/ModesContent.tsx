...
const ModesContent = ({route}: any) => {
    ...
    return (
        <View style={{paddingLeft: 20, paddingRight: 20, paddingTop: 70}}>
            ...
            <Text style={{textAlign: 'center', fontWeight: 'bold', borderColor: 'black', borderWidth: 2, borderRadius: 10, marginTop: 5, backgroundColor: '#dbebe8'}}>{params.textBold1}</Text>
            ...
            <Text style={{textAlign: 'center', fontWeight: 'bold', borderColor: 'black', borderWidth: 2, borderRadius: 10, marginTop: 5, backgroundColor: '#dbebe8'}}>{params.textBold2}</Text>
            ...
            <Text style={{textAlign: 'center', fontWeight: 'bold', borderColor: 'black', borderWidth: 2, borderRadius: 10, marginTop: 5, backgroundColor: '#dbebe8'}}>{params.textBold3}</Text>
